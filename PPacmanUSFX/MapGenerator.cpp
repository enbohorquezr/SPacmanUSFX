	...
	while (getline(file, line)) {
		...
		for (unsigned int x = 0; x < chars.size(); x++) {
			...
			switch (chars[x])
			{
				//recursos laberinto
			case 'z':
				newObject = new Pared(paredTexture, x *250 , y *250, 250, 250, anchoPantalla, altoPantalla);
				break;
			case 'y':
				newObject = new Pared(paredHTexture, x *250, y *250 , 250, 250, anchoPantalla, altoPantalla);
				break;
			case 'v':
				newObject = new Pared(paredCTexture, x * 250, y * 250, 250, 250, anchoPantalla, altoPantalla);
				break;
			case 'n':
				newObject = new Pared(paredC2Texture, x * 250, y * 250, 250, 250, anchoPantalla, altoPantalla);
				break;
			case 'm':
				newObject = new Pared(paredC3Texture, x * 250, y * 250, 250, 250, anchoPantalla, altoPantalla);
				break;
			case 'ñ':
				newObject = new Pared(paredC4Texture, x * 250, y * 250, 250, 250, anchoPantalla, altoPantalla);
				break;
			case 'h':
				newObject = new Pared(paredC5Texture, x * 250, y * 250, 250, 250, anchoPantalla, altoPantalla);
				break;
			case 'j':
				newObject = new Pared(paredC6Texture, x * 250, y * 250, 250, 250, anchoPantalla, altoPantalla);
				break;


			case '.':
				newObject = new Moneda(monedaTexture, x * 250, y * 250, 250, 250, anchoPantalla, altoPantalla);
				//newObject->setParametrosAnimacion(4);
				break;
			case 'o':
				newObject = new Moneda(superMonedaTexture, x * 250, y * 250, 250, 250, anchoPantalla, altoPantalla);
			...
			case 'p':
				...
				break;
			case 'b':
				newObject = new Fantasma(fantasma1Texture, x * 25, y * 25, 250, 250, anchoPantalla, altoPantalla, 2);
				newObject->setParametrosAnimacion(2);
				break;
			case 'c':
				newObject = new Fantasma(fantasma2Texture, x * 25, y * 25, 250, 250, anchoPantalla, altoPantalla, 3);
				newObject->setParametrosAnimacion(4);
				break;
			case 'i':
				newObject = new Fantasma(fantasma3Texture, x * 25, y * 25, 250, 250, anchoPantalla, altoPantalla, 3);
				newObject->setParametrosAnimacion(4);
				break;
			case 'a':
				newObject = new Fantasma(fantasma4Texture, x * 25, y * 25, 250, 250, anchoPantalla, altoPantalla, 3);
				newObject->setParametrosAnimacion(4);
				break;
			//case 'q':
			...
			case 'g':
				newObject = new Fruta(frutaTexture, x *250, y *250, 250, 250, anchoPantalla, altoPantalla);
				newObject->setParametrosAnimacion(4);
				break;
			}
