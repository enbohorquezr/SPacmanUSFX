...
int GameManager::onExecute() {
	...
	//generadorNivelJuego->load("Resources/nuevos/mapa2.txt");
...
bool GameManager::onInit() { 
	...
	{
		//Create window
		gWindow = SDL_CreateWindow("Pacman USFX", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 1366, 768, SDL_WINDOW_SHOWN);
		if (gWindow == NULL)
		{
